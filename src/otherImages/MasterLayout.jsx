            ...
            <>
              ...
              <li>
                <NavLink
                  ...
                  className={(navData) => (navData.isActive ? "active-page" : "")}
                >
                  <Icon icon='tabler:building-store' className='menu-icon' width="28" height="28" />
              ...
              <li>
                <NavLink
                  ...
                  className={(navData) => (navData.isActive ? "active-page" : "")}
                >
                  <Icon icon='solar:calendar-bold' className='menu-icon' width="23" height="23" style={{marginRight:"10px",}} />
              ...
              <li>
                <NavLink
                  ...
                  className={(navData) => (navData.isActive ? "active-page" : "")}
                >
                  <Icon icon='material-symbols:settings-rounded' className='menu-icon' width="23" height="23" style={{marginRight:"10px",}} />
                  <span>Settings</span>
                </NavLink>
              </li>    
            </>
            ...
            <div className='col-auto'>
              <div className='d-flex flex-wrap align-items-center gap-3'>
                <div className="announcementButton">
                  <Link onClick={handleShowCreateModal} className="firstHeadBtn d-flex gap-10">
